...
После этого одной из главных целей должна быть установка вашей собственной программы исследований и повышения репутации. Для аспирантов следует особенно подчеркнуть тот факт, что всех будет заботить только то, что ты делаешь, а не то, какую степень ты при этом планируешь получить (result first!). Для примера предлагаю посмотреть прекрасное руководство от Шерри по подготовке [резюме для академических позиций](http://drsherrirose.com/academic-cvs-for-statistical-science-faculty-positions).
...
Методическая работа должна включать следующие части:
  ...
  1. __Краткое содержание__: В идеале 4-5 предложений, объясняющих (а) какую проблему вы решали, (б) почему это должно волновать других, (в) как вы решили проблему, (г) какие результаты получили, (д) ссылка на [разработанный софт](https://github.com/jtleek/rpackages), который реализует ваш метод.
...
Я учился стилю, копируя манеру других. Есть много отличных ученых, манеру письма которых вы могли бы попробовать воспроизвести (например, [John Storey](http://www.genomine.org/),  [Nancy Reid](http://www.utstat.utoronto.ca/reid/), [Shirley Liu](http://liulab.dfci.harvard.edu/), [Brad Efron](http://statweb.stanford.edu/~ckirby/brad/), и [Robert May](https://scholar.google.com/citations?user=ScXat-4AAAAJ)). Как и в случае с любым писательством, в науке так же работает право: чем больше ты пишешь, тем лучше это у тебя получается.
